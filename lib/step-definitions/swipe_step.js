...
0;
When(/^04_User meng - swipe secara vertikal ke bawah$/, async () => {
  await driver.pause(2000);
  await swipePage.swipe(320, 320, 400, 50, 0, 1000);
  await driver.pause(1500);
  await swipePage.swipe(320, 320, 1100, 650, 0, 1000);
  await driver.pause(1000);
  await swipePage.swipe(320, 320, 1100, 650, 0, 1000);
  await driver.pause(1000);
  await swipePage.swipe(320, 320, 1100, 550, 0, 1000);
});
...
When(/^05_User meng - swipe secara vertikal ke atas$/, async () => {
  await driver.pause(2000);
  await swipePage.swipe(122, 122, 100, 500, 0, 1000);
});
